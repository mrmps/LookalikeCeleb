...
const GitHubStarsButton = React.forwardRef<HTMLAnchorElement, GitHubStarsButtonProps>(
  (
    {
      username,
      repo,
  ...
  return (
    <motion.a
      ...
      className={cn(
        ...
        // sizing
        "text-xs sm:text-sm px-2 sm:px-4 py-1 sm:py-2 h-8 sm:h-10",
        // visual
        "bg-white text-black border border-gray-300 rounded-lg has-[>svg]:px-2 sm:has-[>svg]:px-3 cursor-pointer whitespace-nowrap font-medium",
        "transition-colors disabled:pointer-events-none disabled:opacity-50",
        // child svg default size
        "[&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-[16px] sm:[&_svg:not([class*='size-'])]:size-[18px] shrink-0 [&_svg]:shrink-0",
        // focus & hover
        "outline-none focus-visible:border-gray-500 focus-visible:ring-gray-500/50 focus-visible:ring-[3px] hover:bg-gray-50",
        className,
      )}
      {...props}
    >
      ...
      <div className="hidden sm:inline-flex relative size-[18px] shrink-0">
        <Star
