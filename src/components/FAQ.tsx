...
const FAQ = () => {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "Yes, CelebLook supports all common image formats including JPG, PNG, and HEIC. You can upload photos from your gallery or take a new photo directly through the app."
    },
    {
